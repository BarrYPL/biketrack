class ChainsController < ApplicationController
  ...
  def create
    puts "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx #{@bike.class}"
  ...
  private
    ...
    def chain_params
      params.fetch(:chain, {}).permit(:chain_name, :chain_model, :vaxed_timestamp, :changed_timestamp, :kmoffset, :bike)
    end
end
