class LoginController < ApplicationController
    ...
    def authenticate
        ...
        response = Excon.post(strava_key_handler, :body => .encode_www_form(:client_id => '113042', :client_secret => 'c9fb38720c6838d9f42ef6bace73ca694f948eaa', :code => params[:code], :grant_type => 'authorization_code'))
        puts response.body
